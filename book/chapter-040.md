...
Decision framework to choose workflow, agent, or hybrid execution modes.
...
- Deterministic work prefers workflows
- Open-ended goals prefer agents
- Hybrid is the common production default
...
- Prior Part V chapters through 39

## Motivation

Demo agents break under real traffic: no budgets, no approvals, no metrics, no security boundary, no scale plan. This chapter makes **Workflows vs Agents** an operable subsystem.

## First Principles

### 1. Deterministic work prefers workflows

### 2. Open-ended goals prefer agents

### 3. Hybrid is the common production default
...
See `code/chapter-040/` for the `modechoice` package, CLI, and tests.
