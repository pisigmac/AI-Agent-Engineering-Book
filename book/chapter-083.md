...
Part IX **Real Projects** — full application **Research Agent** implemented as package `research`.
...
- Design end-to-end architecture for a **Research Agent**
...
Ship **Research Agent** as an offline-verified package with tests and Docker.

## Deployment

```bash
docker build -t ch083-research code/chapter-083
docker run --rm ch083-research
```
...
| Docker | `code/chapter-083/Dockerfile` |
