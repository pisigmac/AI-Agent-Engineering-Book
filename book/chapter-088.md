...
Part IX **Real Projects** — full application **Customer Support Agent** implemented as package `support`.
...
- Design end-to-end architecture for a **Customer Support Agent**
...
Ship **Customer Support Agent** as an offline-verified package with tests and Docker.

## Deployment

```bash
docker build -t ch088-support code/chapter-088
docker run --rm ch088-support
```
...
| Docker | `code/chapter-088/Dockerfile` |
